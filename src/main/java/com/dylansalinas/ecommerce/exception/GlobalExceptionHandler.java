...
public class GlobalExceptionHandler {
    ...
    // { "nombre": "El nombre no puede estar vacÃ­o", "precio": "Debe ser mayor que cero" }
    //
    // VersiÃ³n simplificada (solo devuelve el primer error):
    ...
    public ResponseEntity<String> manejarExcepcionGenerica(Exception ex) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("OcurriÃ³ un error inesperado: " + ex.getMessage());
    }
}
